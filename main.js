...
function multiOfInitialAndQuantity(initial,quantity,current){
     ...
     if(initial > current){
        ...
        showOutput(`sad to know that your loss is ${loss} and percentage is ${lossPercentage} %` );
     }
     else if(current > initial){
         var profit = (current - initial) * quantity;
         var profitPercentage = (profit / initial) * 100;
         showOutput(`Good to know that your profit is ${profit} and percentage is ${profitPercentage} %`)
